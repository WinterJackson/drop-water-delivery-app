...
/**
 * Help & support — where a rider writes into the admin console's queue.
 *
 * Reachable **before verification**, deliberately: a rider waiting four days on
 * KYC is exactly the person who needs to ask why, and until this screen existed
 * the only route was the app store review page.
 *
 * The ticket's owner is the token's, not this screen's. Nothing here can file
 * against another account.
 */

const CATEGORY_LABELS: Record<string, string> = {
    order: "An order",
    payment: "Payment or earnings",
    delivery: "A delivery",
    bottles: "Bottles",
    account: "My account",
    app: "The app itself",
                ...
                {isLoading ? (
                    ...
                    <View className="flex-1 pt-6">
                        <EmptyState
                            mood="search"
                            title="Nothing open"
                            subtitle="Stuck on a delivery, a payment or your verification? Send us a message and we'll come back to you in the app."
                ...
                >
                    ...
                    <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
                        ...
                        <TextInput
                            ...
                            maxLength={200}
                            placeholder="e.g. My KYC has been pending for four days"
                        ...
                        <TextInput
                            ...
                            placeholder="Tell us what you were doing and what went wrong. Order numbers help."
                            placeholderTextColor={darkTheme ? "#6b7280" : "#9ca3af"}
