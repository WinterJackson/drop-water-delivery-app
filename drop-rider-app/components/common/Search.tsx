...
const SearchBar = ({
	...
	return (
		<View
			className={`px-4 flex-row items-center gap-2 flex-1 ${darkTheme ? "bg-surface-variant border-transparent" : "bg-white border-gray-200"} rounded-full border ${width} ${height}`}
