...
from sqlalchemy import Column, String, Text, Boolean, Numeric, TIMESTAMP, Float, Time, Integer, ARRAY, func, Index, Enum, Computed
...
class Vendor(Base):
  ...
  # Generated by Postgres. See the note on `Product.search_vector`: "optional if
  # created directly in DB" was the assumption that left this NULL on every row
  # of every bootstrapped database, and vendor search silently empty with it.
